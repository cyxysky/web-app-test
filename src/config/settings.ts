...
export const runtimeEnvDefinitions: RuntimeEnvDefinition[] = [
  ...
  { key: 'BROWSER_PREVIEW_VIDEO_MAX_WIDTH', label: '视频流最大宽度', description: '视频输出目标上限；支持 2K（2560）和 4K（3840/4096），通过合成器提高抓取像素密度，不改变网页 CSS 视口和布局。', tab: 'browser', defaultValue: '1920', control: 'number', min: 320, max: 4096, step: 2 },
  { key: 'BROWSER_PREVIEW_VIDEO_MAX_HEIGHT', label: '视频流最大高度', description: '视频输出目标上限；支持 2K（1440）和 4K（2160），通过合成器提高抓取像素密度，不改变网页 CSS 视口和布局。', tab: 'browser', defaultValue: '1080', control: 'number', min: 240, max: 2160, step: 2 },
  ...
  { key: 'BROWSER_USER_BROWSER_IDLE_TIMEOUT_MS', label: '用户浏览器空闲回收时间', description: '同一用户没有运行中的对话和实时预览后，等待该时长关闭其测试浏览器，单位毫秒；默认 10 分钟。', tab: 'browser', defaultValue: '600000', control: 'number', min: 60000, max: 86400000, step: 60000 },
