...
export const runtimeEnvDefinitions: RuntimeEnvDefinition[] = [
  ...
  { key: 'AI_BROWSER_MODE', label: '浏览器控制模式', description: '使用页面 DOM、Shadow DOM 与按需局部无障碍语义生成统一 UID；视觉信息通过 takeScreenshot 按需获取。', tab: 'browser', defaultValue: 'dom', control: 'select', options: [{ label: '语义快照', value: 'dom' }] },
