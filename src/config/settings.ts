...
export const runtimeEnvDefinitions: RuntimeEnvDefinition[] = [
  ...
  { key: 'LIBREOFFICE_PATH', label: 'LibreOffice 路径', description: '可选的 soffice/libreoffice 可执行文件绝对路径。配置后，Word、Excel、PowerPoint 和 OpenDocument 附件会先转为 PDF，再按页交给视觉模型；留空时自动搜索系统安装。', tab: 'runtime', defaultValue: '', control: 'text' },
