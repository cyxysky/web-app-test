...
export const runtimeEnvDefinitions: RuntimeEnvDefinition[] = [
  ...
  { key: 'AI_CONTEXT_SUMMARY_MODE', label: '上下文摘要模式', description: '上下文压缩时使用 AI 结构化摘要，或只使用确定性 fallback 摘要。', tab: 'runtime', defaultValue: 'ai', control: 'select', options: [{ label: 'AI 结构化摘要', value: 'ai' }, { label: 'Fallback 摘要', value: 'fallback' }] },
