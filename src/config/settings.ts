...
export const runtimeEnvDefinitions: RuntimeEnvDefinition[] = [
  ...
  { key: 'VISUAL_MARKER_SEPARATE_MAP', label: '单独标记图', description: '是否把标记图和原截图分开发给模型。', tab: 'browser', defaultValue: 'false', control: 'boolean', options: boolOptions },
  ...
  { key: 'REPLAY_STEP_DELAY_MS', label: '回放步骤间隔', description: '固定流程回放时每步之间的等待时间。', tab: 'runtime', defaultValue: '0', control: 'number' },
