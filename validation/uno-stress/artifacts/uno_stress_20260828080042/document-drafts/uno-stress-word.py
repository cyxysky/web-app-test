...
def create_document(job):
    ...
    layout.add_paragraph('section-04/caption', '表 1：18 行压力表格。表格之后必须保留自然间距。', font_size=9, italic=True, color=0x64748B, space_before=160, space_after=220)
    # @webpilot-endunit
    ...
    layout.add_paragraph('section-06/intro', '本页对象位于独立页面，避免与流式正文发生非预期重叠。', font_size=11, space_after=300)
